...
xgb_model_pk = joblib.load('C:/Users/prave/OneDrive/Learning/upGrad/CapStone/MainProjects/FinalDeliverables/xgb_model.pkl')
item_final_rating_pk = joblib.load('C:/Users/prave/OneDrive/Learning/upGrad/CapStone/MainProjects/FinalDeliverables/item_final_rating.pkl')
...
def predict():
    ...
    Top20_Recomm_products_df = pd.DataFrame(Top20_Recomm_products)
    ...
    Top5_recommended_products=Top20_Prod_reviews.groupby(['name']).sum().sort_values(by='Sentiscore',ascending=False)[0:5]
